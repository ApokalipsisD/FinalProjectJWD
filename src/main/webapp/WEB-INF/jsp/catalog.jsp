                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="startDate" class="form-control" id="startDate" placeholder="Input start date"
                                       aria-label="startDate" aria-describedby="basic-addon1" required>
                            </div>

                            <div class="form-group">
                                <label for="endDate">Ending</label>
                                <input type="date" name="endDate" class="form-control" id="endDate" placeholder="Input end date"
                        ...
                        <div class="modal-footer">
                            ...
                            <button href="${pageContext.request.contextPath}/controller?command=show_courses" type="submit" class="btn btn-primary">Save</button>
                        </div>
...
<div class="container justify-content-center mt-50 mb-50">
    <div class="row">
        <div class="col-md-10">
            <form action="${pageContext.request.contextPath}/controller?command=catalog" method="post">

                <c:forEach var="i" begin="0" end="${sessionScope.catalog.size()-1}">
                    <div class="card card-body mt-3">
                        <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                            <div class="mr-2 mb-3 mb-lg-0"></div>
                            <div class="media-body">
                                <h6 class="media-title font-weight-semibold"><a
                                        href="${pageContext.request.contextPath}/controller?command=catalog"
                                        data-abc="true">${sessionScope.catalog.get(i).title}</a></h6>
